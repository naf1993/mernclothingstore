...
import { addToWishList, createProduct, deleteProduct ,getAllProducts, getProductById, getProductStatistics, getProductsByCategory, getProductsBySubCategory, getSimilarProducts, productSearch, resizeCoverImage, resizeImages, updateProduct, uploadProductImages } from '../controllers/productController.js';
...
router.route('/').get(getAllProducts).post(protect,restrictToAdmin,uploadProductImages,resizeCoverImage,createProduct)
router.route('/:id').get(getProductById).patch(protect,restrictToAdmin,uploadProductImages,resizeImages,updateProduct).delete(protect,restrictToAdmin,deleteProduct)
