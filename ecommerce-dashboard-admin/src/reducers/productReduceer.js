import { PRODUCT_IMAGE_DELETE_FAIL, PRODUCT_IMAGE_DELETE_REQUEST, PRODUCT_IMAGE_DELETE_SUCCESS, PRODUCT_LIST_SUCCESS } from "../constants/productConstants"
...
export const productCreateReducer = (state = { loading: false, success: false, product: null }, action) => {
    switch (action.type) {
        ...
        case PRODUCT_CREATE_RESET:
            return { loading: false, success: false, product: null };
        default:
            return state;
    }
};
