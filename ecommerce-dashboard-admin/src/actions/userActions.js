import {
  ...
  USER_LOGIN_REQUEST,
  USER_LOGIN_SUCCESS,
  USER_LOGOUT,USER_LIST_REQUEST,USER_LIST_SUCCESS,USER_LIST_FAIL,USER_LIST_RESET, USER_UPDATE_REQUEST, USER_UPDATE_SUCCESS, USER_UPDATE_FAIL
...
export const updateUserStatusByAdmin = (user)=>async(dispatch,getState)=>{
    try{
       ...
       const {data} = await axios.patch(`/api/users/updateStatus/${user._id}`,user,config)
